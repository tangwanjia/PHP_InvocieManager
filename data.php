...
//import db stly
  ...
  //try catch plog (create PDO connection to DB)
  try {
  ...
  $sql = 'select * from invoices join statuses on statuses.id = invoices.status_id';
  $result = $db->query($sql);
  $invoices = $result->fetchAll();

  // var_dump($invoices);
  // exit; //exit for nothing runs for others, just for this part and exit automatically.
